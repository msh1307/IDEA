...
TOOL_DEFINITIONS = [
    ...
    {"name": "decompile", "description": "Decompile a function; view=compact, header, or full."},
    ...
    {"name": "repair_function_analysis", "description": "Repair a function by defining, renaming, declaring, reanalyzing, and decompiling."},
    ...
    {"name": "export_decompiled_c", "description": "Export all or filtered functions to one .c file."},
